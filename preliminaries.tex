...
\begin{definition}\label{def:realizable}
  Sequences $p = (p_3, \dots, p_m)$, $q = (q_3, \dots, q_m)$ are said to be realizable, if there exists a polyhedron having $p$ as its $p$-vector and $q$ as its $v$-vector.
\end{definition}

...
In the following part a theorem of Eberhards type will be proven for $5$-valent polyhedra. The proof utilizes the already established Eberhards theorem \ref{thm_eberhard}(\ref{thm_eberhard_4}) for construction of the new solid.
\begin{theorem}

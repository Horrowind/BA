...
\begin{lemma}\label{thm:case3:6:mainlemma}
  ...
  All the requirements in the statement will help utilizing Eberhard's \autoref{thm:eberhard:3}. The condition $p_4 + p_5 \leq 6$ deals with different the sign of curvatures when having valence $3$ and $4$ (note that quadrangles and pentagons have positive curvature in the case of $3$-valence but zero or negative curvature in the other case), while the condition $3 \mid \sum_{k=3}^{n} p_k - 2$ is necessary to keep the number of triangles natural.
  \begin{proof}
